...
<!--[if gt IE 8]><!--> <html class="no-js" lang="en"> <!--<![endif]-->
  ...
  <body class="app header-fixed sidebar-fixed sidebar-lg-show">
    ...
    <script src="<?php echo $prefix;?>assets/plugins/coreui-pro-2.0.7/dist/js/coreui.min.js"></script>
    <script src="<?php echo $prefix;?>assets/plugins/coreui-pro-2.0.7/dist/js/coreui-utilities.min.js"></script>
