  ...
  <body class="app header-fixed sidebar-fixed sidebar-lg-show">
    ...
    <div class="app-body">
      ...
      <main class="main">
          ...
          <div class="animated fadeIn">
            ...
            <section class="at-heading">
              <div class="container container-sm">
                <h1>Cover</h1>
                <p>Cover which usually used for the start of the page. In the form of static image / carousel with text and image background.</p>
              </div>
            </section>
            ...
            <section class="at-section">
              ...
              <div class="at-example">
                <div class="container-fluid">
                  <!--Start: Cover - Static-->
                  <section class="cover" style="background: linear-gradient(rgba(0,0,0, .2), rgba(0,0,0, .2)), url(<?php echo $prefix;?>assets/img/sample/bg_rectangle-dark-1.jpg) no-repeat center; background-size: cover;">
        ...
        <span class="nt">&lt;section</span> <span class="na">class=</span><span class="n">"cover"</span> <span class="na">style=</span><span class="n">"background: url() no-repeat center; background-size: cover;"</span><span class="nt">&gt;</span>
        ...
        <span class="nt">&lt;/section&gt;</span>
            ...
            <section class="at-section">
              ...
              <div class="at-example">
                <div class="container-fluid">
                  ...
                  <section class="cover cover-carousel">
                    <div id="carouselCover" class="carousel slide" data-ride="carousel">
                      ...
                      <div class="carousel-inner">
                        <div class="carousel-item active" style="background: linear-gradient(rgba(0,0,0, .2), rgba(0,0,0, .2)), url(<?php echo $prefix;?>assets/img/sample/bg_rectangle-dark-1.jpg) no-repeat center; background-size: cover;">
                          <div class="container">
                        ...
                        <div class="carousel-item" style="background: linear-gradient(rgba(0,0,0, .2), rgba(0,0,0, .2)), url(<?php echo $prefix;?>assets/img/sample/bg_rectangle-dark-2.jpg) no-repeat center; background-size: cover;">
                          <div class="container">
                            <div class="cover-content">
                        ...
                        <div class="carousel-item" style="background: linear-gradient(rgba(0,0,0, .2), rgba(0,0,0, .2)), url(<?php echo $prefix;?>assets/img/sample/bg_rectangle-dark-3.jpg) no-repeat center; background-size: cover;">
                          <div class="container">
                            <div class="cover-content">
                              <h2 class="cover-title">Hello, world!</h2>
                              <p class="cover-text">This is a template for a simple marketing or informational website. It includes a large callout called a jumbotron and three supporting pieces of content. Use it as a starting point to create something more unique.</p>
            ...
            <section class="at-section">
              <div class="at-subheading">
                <div class="container container-sm">
                  <h3>Cover Responsive</h3>
                  <p>For cover which change states on mobile & on desktop, use <code>.cover-responsive</code>.</p>
                </div>
              </div>
              <div class="at-example">
                <div class="container-fluid">
                  <!--Start: Cover Responsive-->
                  <div class="cover cover-responsive bg-dark">
                    <div class="cover-responsive-img">
                      <div class="cover-responsive-overlay"></div>
                    </div>
                    <div class="container">
                      <div class="cover-content">
                        <h3 class="cover-title animated fadeInUp delayp1">Hello, world!</h3>
                        <p class="cover-text animated fadeInUp delayp2">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Aliquid doloribus perferendis fuga.</p>
                      </div>
                    </div>
                  </div>
            ...
            <section class="at-section">
              <div class="container container-sm">
                <p>For cover which change states on mobile & on desktop, and use carousel as the content.</p>
              </div>
              <div class="at-example">
                <div class="container-fluid">
                  <!--Start: Cover Responsive - Carousel-->
            ...
            <section class="at-section">
              <div class="at-subheading">
                <div class="container container-sm">
                  <h3>Parallax</h3>
                  <p>To use parallax, add <code>.parallax-window</code> to the <code>div</code> above <code>.cover</code> and use <code>data-image-src</code> attribute inside it. Make sure the height of the background image used are all the same.</p>
                </div>
              </div>
              <div class="at-example">
                <div class="container-fluid">
                  <!--Start: Parallax-->
                  <div class="parallax-window" data-image-src="<?php echo $prefix;?>assets/img/sample/bg_rectangle-light-1.jpg">
                    <div class="cover">
                      <div class="container justify-content-center">
                        <div class="cover-content text-center">
                          <h1 class="cover-title animated fadeInUp delayp1">Hello, world!</h1>
              ...
              <div class="at-example">
                <div class="container-fluid">
                  ...
                  <div id="carouselImg" class="carousel slide" data-ride="carousel">
                    ...
                    <div class="carousel-inner">
                      <div class="carousel-item active">
                        <img class="img-fluid" src="<?php echo $prefix;?>assets/img/sample/bg_rectangle-dark-1.jpg" alt="First slide">
                      </div>
                      <div class="carousel-item">
                        <img class="img-fluid" src="<?php echo $prefix;?>assets/img/sample/bg_rectangle-dark-2.jpg" alt="Second slide">
                      </div>
                      <div class="carousel-item">
                        <img class="img-fluid" src="<?php echo $prefix;?>assets/img/sample/bg_rectangle-dark-1.jpg" alt="Third slide">
                      </div>
                    </div>
