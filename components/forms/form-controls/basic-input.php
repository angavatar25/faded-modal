...
<!--[if gt IE 8]><!--> <html class="no-js" lang="en"> <!--<![endif]-->
  ...
  <body class="app header-fixed sidebar-fixed sidebar-lg-show">
        ...
        <div class="container-fluid">
          <div class="animated fadeIn">
                ...
                <div class="container container-sm">
                  ...
                  <form class="needs-validation" novalidate>
                    <div class="row">
                      ...
                      <div class="col-12">
                        <div class="form-group">
                          <label for="validationCustom07">Attachment</label>
                      ...
                      <div class="col-12">
                        <div class="form-group">
                          <label for="validationCustom08">Gender</label>
            ...
            <section class="at-section">
              <div class="at-subheading">
                <div class="container container-sm">
                  <h3>Password Toggle Visibility</h3>
              ...
              <div class="at-example bg-light">
                <div class="container container-sm">
                  ...
                  <div class="input-group">
                    <input type="password" class="form-control form-control-password" placeholder="Enter password">
                    <div class="input-group-append">
                      <span class="input-group-text"><i class="fal fa-eye"></i></span>
                    </div>
                  </div>
                  <!--END: Password Toggle-->
                </div>
    ...
    <script>
      ...
      $('.form-control-password + .input-group-append').on('click', function() {
        $('.form-control-password + .input-group-append i').toggleClass('fa-eye-slash').toggleClass('fa-eye');
        // $('.form-control-password').togglePassword();
        //   if (x.attr('password')) {
        //     x.removeAttr('password');
        //   } else {
        //     x.attr('text';
        //   }
      });
