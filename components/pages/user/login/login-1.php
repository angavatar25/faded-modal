    ...
    <section class="row row-0 section-login">
      <div class="col-md-6 login-aside">
        ...
        <div class="login-aside-footer">
          <span class="login-aside-copyright">© 2018 <a href="#"> Antikode</a></span>
          <div class="login-aside-links">
      ...
      <div class="col-md-6 login-main">
        ...
        <!-- <div class="login-main-header">
          Already have an account? <a href="<?php echo $prefix;?>login">Login</a>
        </div> -->
        <div class="login-main-content">
          ...
          <div class="login-main-divider">
            <span></span>
            <span>OR</span>
            <span></span>
          </div>
          <div class="login-main-options">
            <div class="row">
              <div class="col-4">
                <a href="#" class="btn btn-primary btn-block btn-google"><i class="fab fa-google"></i> <span>Google</span></a>
              </div>
              <div class="col-4">
                <a href="#" class="btn btn-primary btn-block btn-facebook"><i class="fab fa-facebook"></i> <span>Facebook</span></a>
              </div>
              <div class="col-4">
                <a href="#" class="btn btn-primary btn-block btn-twitter"><i class="fab fa-twitter"></i> <span>Twitter</span></a>
              </div>
            </div>
          </div>
